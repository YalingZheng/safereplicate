...
# path (e.g. /osg/home/yzheng/hello1.txt, which is collection_name plus file name, do I need to parse out the file name?
...
SafeReplicateRule2{
	...
	*Item0 = str(elem(*PathItems, 0));
	*Item1 = str(elem(*PathItems, 1));
	*UserName = str(elem(*PathItems, 2));
	*FileName = str(elem(*PathItems, 3));							
	*CollectionName = "/"++"*Item0"++"/"++"*Item1"++"/"++"*UserName";
...
input *Path="osg/home/yzheng/hello3.txt", *ResourceGroup = "osgSrmGroup"
output ruleExecOut 
