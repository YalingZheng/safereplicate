 ...
 */
blbn_state_t* blbn_init_state (char *experiment_name, char *data_filepath, char *test_data_filepath, char *model_filepath,
...
void blbn_learn_case_v2 (blbn_state_t *state, int case_index) {
	//printf("begin of blbn_learn_case_v2!\n");
...
void blbn_learn (blbn_state_t *state, int policy) {
	...
	selection_time = 0.0;
	printf("%f ", test_rates[0]);

	test_rates[0] = test_rates[0]+0.0*MIN(i,50)/50;
