 ...
 * so that controlled experiments can be done, 
...
// Function prototypes
int blbn_init ();
blbn_state_t* blbn_init_state (char* type_net, char *experiment_name, char *data_filepath, char *validation_data_filepath, char *model_filepath,
